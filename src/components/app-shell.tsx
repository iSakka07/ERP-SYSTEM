...
import { BanknoteArrowUp, Building2, ChartNoAxesCombined, FileSpreadsheet, LayoutDashboard, LockKeyhole, Menu, Paperclip, Settings2, ShoppingCart, UsersRound, Vault, X } from "lucide-react";
