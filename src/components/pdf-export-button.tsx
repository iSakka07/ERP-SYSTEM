...
const reportDefinitions: ReportDefinition[] = [
  ...
  { path: "/expenses", title: "تقرير أعمال ومستخلصات مقاولي الباطن", columns: ["المقاولة / النطاق", "المقاول", "المشروع", "تكلفة الأعمال", "صافي المستحق", "المدفوع", "المتبقي / المديونية / المقدم", "الجوارى"], countLabel: "عدد المقاولات", totalColumns: { "تكلفة الأعمال": "sum", "صافي المستحق": "sum", "المدفوع": "sum" }, kpiLabels: ["تكلفة الأعمال المعتمدة", "صافي مستحق المقاولين", "المدفوع فعليًا", "المتبقي للمقاولين"] },
