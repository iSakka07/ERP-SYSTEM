    ...
    <main className="grid min-h-screen bg-slate-100 lg:grid-cols-[1.05fr_0.95fr]" dir="rtl">
      <section className="relative hidden overflow-hidden bg-[#10192d] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative flex items-center gap-3">
          <span className="grid size-12 place-items-center rounded-2xl bg-blue-600 shadow-xl shadow-blue-950/40"><Building2 className="size-6" /></span>
          <div><p className="text-lg font-extrabold tracking-wide">ERP-SYSTEM V1</p><p className="text-xs text-slate-400">إدارة شركة المقاولات</p></div>
        </div>
      ...
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-6 shadow-xl shadow-slate-300/30 sm:p-9">
          <div className="mb-7 flex items-center gap-3 lg:hidden"><span className="grid size-11 place-items-center rounded-xl bg-blue-600 text-white"><Building2 className="size-5" /></span><div><p className="font-extrabold text-slate-900">ERP-SYSTEM V1</p><p className="text-[11px] text-slate-500">إدارة شركة المقاولات</p></div></div>
